...
import static com.mlijo.aryaym.konsumen_mlijo.Base.BaseActivity.getUid;
...
public class DaftarTransaksiPresenter {
    ...
    DaftarTransaksiPresenter(DaftarTransaksiActivity view){
        ...
        mQuery = mDatabase.child(Constants.KONSUMEN).child(getUid())
                .child(Constants.PEMBELIAN).child(jt);
    }
