...
public class DaftarProdukPenjualActivity extends BaseActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new DaftarProdukPenjualPresenter(this);
        ...
        mQuery = mFirestore.collection(Constants.PRODUK_REGULER)
                ...
                .whereEqualTo(Constants.ID_KATEGORI, kategoriProduk)
                .limit(10);
