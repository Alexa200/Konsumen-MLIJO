...
import static com.mlijo.aryaym.konsumen_mlijo.Utils.Constants.REQUEST_CODE_READ_EXTERNAL_STORAGE;
import static com.mlijo.aryaym.konsumen_mlijo.Utils.Constants.RESULT_LOAD_IMAGE;
...
public class ObrolanActivity extends BaseActivity implements View.OnClickListener, ChildEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        penerimaId = getIntent().getStringExtra(Constants.ID_PENJUAL);
